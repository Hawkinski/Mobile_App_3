...
/**
 * Created by Sachin on 08,June,2017
 * Hawkinski,
 * Dubai, UAE.
 */
public class FillTaskList3 extends AsyncTask<String, String, List<TaskListData>> {
    ...
    private PPMTaskFragment frag2;
    private InspectionTaskFragment frag1;
    private RegularTaskFragment frag3;
    private CompletedTaskFragment frag4;
    ...
    private RandomTaskFragment  frag5;

    private String taskType;
    int pageNo=0;
    public FillTaskList3(int i, FragmentActivity activity, InspectionTaskFragment frag1, PPMTaskFragment frag2, RegularTaskFragment frag3, CompletedTaskFragment frag4, RandomTaskFragment frag5 , SharedPreferences sp, int pageNo, ProgressDialog pdialog, String taskType) {
        this.x = i;
        this.sp = sp;
        this.pageNo=pageNo;
    ...
    public void onPostExecute(List<TaskListData> list) {
        ...
        if(list!=null){
            ...
            if(taskType.equalsIgnoreCase("INSP")){
                if(frag1!=null){


                    frag1.fillTaskList(list);
            ...
            else if(taskType.equalsIgnoreCase("PPM")){
                if(frag2!=null){

                    frag2.fillTaskList(list);
    ...
    public interface FillTaskInterface{
        ...
        void fillTaskList2(List<TaskListData> list);
    }
