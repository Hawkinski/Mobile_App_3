 ...
 */
public class CompletedTaskFragment extends Fragment implements RVAdapter.itemClick,FillTaskList2.FillTaskInterface,FillTaskList3.FillTaskInterface{
    // TODO: Rename parameter arguments, choose names that match
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER
    private static final String ARG_PARAM1 = "param1";
    private static final String ARG_PARAM2 = "param2";
    private String taskType="CT";
    ...
    public CompletedTaskFragment(SharedPreferences sp, ProgressDialog pdialog,int flag) {
        this.sp = sp;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = (RecyclerView)view.findViewById(R.id.completedRecyclerview);
        ...
        if (isAdded()) {
            ...
            scrollListener = new EndlessRecyclerViewScrollListener(linearLayoutManager) {
                ...
                public void onLoadMore(int page, int totalItemsCount, RecyclerView view) {
                    ...
                    FillTaskList2 fill = new FillTaskList2(flag,CompletedTaskFragment.this.getActivity(),null,null,null,CompletedTaskFragment.this,null,sp,(page+1),pdialog,taskType);
                    fill.execute();
    ...
    public void onResume(){
        super.onResume();
        data = new ArrayList<>();
        FillTaskList3 fill = new FillTaskList3(flag,this.getActivity(),null,null,null,this,null,sp,1,pdialog,taskType);
        fill.execute();
    }
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if(isVisibleToUser && isAdded() ){
            data = new ArrayList<>();
            FillTaskList3 fill = new FillTaskList3(flag,this.getActivity(),null,null,null,this,sp,1,pdialog,taskType);
            fill.execute();
            isLoaded =true;
        }
    }*/
...
//                    Toast.makeText(this.getActivity(),msg, Toast.LENGTH_LONG).show();
                    ...
                    radapter.SetOnClick(CompletedTaskFragment.this);
...
//                    Toast.makeText(this.getActivity(),msg,Toast.LENGTH_LONG).show();
    ...
    public class Consume extends AsyncTask<String, String, Integer> {
        ...
        public void onPostExecute(Integer s) {
            ...
            if (s == 1) {
                Intent i = new Intent(CompletedTaskFragment.this.getActivity(), TaskStartActivity.class);
                ...
                Intent i = new Intent(CompletedTaskFragment.this.getActivity(), TaskDetailsActivity.class);
