 ...
 * {@link PPMTaskFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link PPMTaskFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class PPMTaskFragment extends Fragment implements RVAdapter.itemClick,FillTaskList2.FillTaskInterface,FillTaskList3.FillTaskInterface {
    // TODO: Rename parameter arguments, choose names that match
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER
    private static final String ARG_PARAM1 = "param1";
    private static final String ARG_PARAM2 = "param2";
    private String taskType="PPM";
    ...
    public PPMTaskFragment() {
        // Required empty public constructor

    }
    @SuppressLint("ValidFragment")
    public PPMTaskFragment(SharedPreferences sp, ProgressDialog pdialog,int flag) {
        this.sp = sp;
    ...
    public static PPMTaskFragment newInstance(String param1, String param2) {
        PPMTaskFragment fragment = new PPMTaskFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_ppmtask, container, false);

        recyclerView = (RecyclerView)view.findViewById(R.id.ppmRecyclerview);
    ...
    /*    FillTaskList3 fill = new FillTaskList3(0,this.getActivity(),null,this,null,sp,1,pdialog,taskType);
        fill.execute();
*/
        ...
        if( isAdded()){
            scrollListener = new EndlessRecyclerViewScrollListener(linearLayoutManager) {
                ...
                public void onLoadMore(int page, int totalItemsCount, RecyclerView view) {
                    ...
                    FillTaskList2 fill = new FillTaskList2(flag,PPMTaskFragment.this.getActivity(),null,PPMTaskFragment.this,null,null,null,sp,(page+1),pdialog,taskType);
                    fill.execute();
    ...
    public void onResume(){
        super.onResume();
        data = new ArrayList<>();
        FillTaskList3 fill = new FillTaskList3(flag,this.getActivity(),null,this,null,null,null,sp,1,pdialog,taskType);
        fill.execute();
    }
   ...
   /* @Override
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if(isVisibleToUser && isAdded() ){
            data = new ArrayList<>();
            FillTaskList3 fill = new FillTaskList3(flag,this.getActivity(),null,this,null,null,sp,1,pdialog,taskType);
            fill.execute();
            isLoaded =true;
        }
    }*/
   ...
   /* @Override
    ...
    public void fillTaskList(List<TaskListData> list) {
        ...
        if(data.size() == 0){
            ...
            if(list.size() == 0){
                String msg = "No PPM task available.";
                data.clear();

//                Toast.makeText(this.getActivity(),msg,Toast.LENGTH_LONG).show();
                radapter = new RVAdapter(this.getActivity(), data, flag,taskType);
                radapter.SetOnClick(PPMTaskFragment.this);
    ...
    public void fillTaskList2(List<TaskListData> list) {
        ...
        if(isAdded()){
            if(data.size() == 0){
                ...
                if(list.size() == 0){
                    String msg ;
                    msg = "No Inspection task available.";
                    data.clear();
...
//                    Toast.makeText(this.getActivity(),msg,Toast.LENGTH_LONG).show();
    ...
    public class Consume extends AsyncTask<String, String, Integer> {
        ...
        public void onPostExecute(Integer s) {
            ...
            if (s == 1) {
                Intent i = new Intent(PPMTaskFragment.this.getActivity(), TaskStartActivity.class);
                ...
                Intent i = new Intent(PPMTaskFragment.this.getActivity(), TaskDetailsActivity.class);
