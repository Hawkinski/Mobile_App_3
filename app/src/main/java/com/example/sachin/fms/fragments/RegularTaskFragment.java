 ...
 * {@link RegularTaskFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link RegularTaskFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class RegularTaskFragment extends Fragment implements RVAdapter.itemClick,FillTaskList2.FillTaskInterface,FillTaskList3.FillTaskInterface{
    // TODO: Rename parameter arguments, choose names that match
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER
    private static final String ARG_PARAM1 = "param1";
    private static final String ARG_PARAM2 = "param2";
    private String taskType="M";
    ...
    public RegularTaskFragment() {
        // Required empty public constructor

    }
    @SuppressLint("ValidFragment")
    public RegularTaskFragment(SharedPreferences sp, ProgressDialog pdialog,int flag) {
        this.sp = sp;
    ...
    public static RegularTaskFragment newInstance(String param1, String param2) {
        RegularTaskFragment fragment = new RegularTaskFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_regular_task, container, false);

        recyclerView = (RecyclerView)view.findViewById(R.id.regularRecyclerview);
        ...
        if(isAdded()){
            scrollListener = new EndlessRecyclerViewScrollListener(linearLayoutManager) {
                ...
                public void onLoadMore(int page, int totalItemsCount, RecyclerView view) {
                    ...
                    FillTaskList2 fill = new FillTaskList2(flag,RegularTaskFragment.this.getActivity(),null,null,RegularTaskFragment.this,null,null,sp,(page+1),pdialog,taskType);
                    fill.execute();
   ...
   /* @Override
    ...
    public void onResume(){
        super.onResume();
        data = new ArrayList<>();
        FillTaskList3 fill = new FillTaskList3(flag,this.getActivity(),null,null,this,null,null,sp,1,pdialog,taskType);
        fill.execute();
    }
    ...
    public void fillTaskList(List<TaskListData> list) {
        ...
        if(isAdded()){
            if(data.size() == 0){
                ...
                if(list.size() == 0){
                    String msg = "No Maintenance task available.";
                    data.clear();

//                    Toast.makeText(this.getActivity(),msg,Toast.LENGTH_LONG).show();
                    radapter = new RVAdapter(this.getActivity(), data, flag,taskType);
                    radapter.SetOnClick(RegularTaskFragment.this);
...
//                    Toast.makeText(this.getActivity(),msg,Toast.LENGTH_LONG).show();
    ...
    public class Consume extends AsyncTask<String, String, Integer> {
        ...
        public void onPostExecute(Integer s) {
            ...
            if (s == 1) {
                Intent i = new Intent(RegularTaskFragment.this.getActivity(), TaskStartActivity.class);
                ...
                Intent i = new Intent(RegularTaskFragment.this.getActivity(), TaskDetailsActivity.class);
