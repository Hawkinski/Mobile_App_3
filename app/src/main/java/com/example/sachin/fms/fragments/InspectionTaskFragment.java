...
import com.example.sachin.fms.classes.FillTaskList;
 ...
 * {@link InspectionTaskFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link InspectionTaskFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class InspectionTaskFragment extends Fragment implements RVAdapter.itemClick,FillTaskList2.FillTaskInterface,FillTaskList3.FillTaskInterface{
    // TODO: Rename parameter arguments, choose names that match
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER
    private static final String ARG_PARAM1 = "param1";
    private static final String ARG_PARAM2 = "param2";
    private String taskType="INSP";
    ...
    public InspectionTaskFragment() {
        // Required empty public constructor

    }
    @SuppressLint("ValidFragment")
    public InspectionTaskFragment(SharedPreferences sp, ProgressDialog pdialog,int flag) {
        this.sp = sp;
    ...
    public static InspectionTaskFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_inspection_task, container, false);

        recyclerView = (RecyclerView)view.findViewById(R.id.inspectionRecyclerview);
        ...
        if (isAdded()) {
            ...
            scrollListener = new EndlessRecyclerViewScrollListener(linearLayoutManager) {
                ...
                public void onLoadMore(int page, int totalItemsCount, RecyclerView view) {
                        ...
                        FillTaskList2 fill = new FillTaskList2(flag,InspectionTaskFragment.this.getActivity(),InspectionTaskFragment.this,null,null,null,null,sp,(page+1),pdialog,taskType);
                        fill.execute();
    ...
    public void onResume(){
        super.onResume();
        data = new ArrayList<>();
        FillTaskList3 fill = new FillTaskList3(flag,this.getActivity(),this,null,null,null,null,sp,1,pdialog,taskType);
        fill.execute();
    }
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if(isVisibleToUser && isAdded() ){
            data = new ArrayList<>();
            FillTaskList3 fill = new FillTaskList3(flag,this.getActivity(),this,null,null,null,sp,1,pdialog,taskType);
            fill.execute();
            isLoaded =true;
        }
    }*/
...
//                    Toast.makeText(this.getActivity(),msg,Toast.LENGTH_LONG).show();
                    ...
                    radapter.SetOnClick(InspectionTaskFragment.this);
...
//                    Toast.makeText(this.getActivity(),msg,Toast.LENGTH_LONG).show();
    ...
    public class Consume extends AsyncTask<String, String, Integer> {
        ...
        public void onPostExecute(Integer s) {
            ...
            if (s == 1) {
                Intent i = new Intent(InspectionTaskFragment.this.getActivity(), TaskStartActivity.class);
                ...
                Intent i = new Intent(InspectionTaskFragment.this.getActivity(), TaskDetailsActivity.class);
