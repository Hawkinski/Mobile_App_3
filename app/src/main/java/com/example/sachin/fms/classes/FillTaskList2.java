 ...
 * Dubai, UAE.
 */
public class FillTaskList2 extends AsyncTask<String, String, List<TaskListData>> {
    ...
    int pageNo=0;
    public FillTaskList2(int i, FragmentActivity activity, InspectionTaskFragment frag1, PPMTaskFragment frag2, RegularTaskFragment frag3 , CompletedTaskFragment frag4, RandomTaskFragment frag5, SharedPreferences sp, int pageNo, ProgressDialog pdialog, String taskType) {
        this.x = i;
        this.sp = sp;
        this.pageNo=pageNo;
